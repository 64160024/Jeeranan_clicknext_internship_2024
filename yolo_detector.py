...
def draw_boxes(frame, boxes, target='cat'):
...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            # Show result
            cv2.putText(frame,'Jeeranan-Clicknext-Internship-2024',org=(650,50),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale=1,color=(0,0,255),thickness=3)
